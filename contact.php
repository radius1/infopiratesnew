    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <img src="images/screenshot1.png" alt="" id="img" class="img-responsive">
            </div>
            
            <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <img src="images/screenshot2.png" alt="" id="img" class="img-responsive">
            </div>
            
            <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <img src="images/screenshot3.png" alt="" id="img" class="img-responsive">
            </div>
            
            <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <img src="images/screenshot4.png" alt="" id="img" class="img-responsive">
            </div>
        </div>
    </div>
